...
# Função principal
# -----------------------------------------------------------------------------
def bufferbloat_reno():
    print(args)
    if not os.path.exists(args.dir):
        os.makedirs(args.dir)

    # Ajusta congestion control do TCP no SO
